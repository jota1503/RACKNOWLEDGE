...
vm.runInThisContext(fs.readFileSync("./formato.js"), { filename: "formato.js" });
...
const POPULATIONS_AFTER_PARSE = {
    // informado por Dave Greene: utiliza caracteres que no son 'o' para células vivas
...
for(let file of files)
{
    ...
    // puede fallar si el archivo rle original no especifica correctamente los límites del patrón
