    ...
    function parse_rle(pattern_string)
    {
        ...
        /*
           Hoy aprendí:
            ...
            Optimice un determinado algoritmo de análisis de cadenas (entrada de 1 megabyte).
            notas:
            1. usando while(str = str.replace(re, callback)): Más de 9000
            2. usando while(match = re.exec(str)): 800ms
            3. usando for(var pos = 0; pos < str.length; pos++) chr = str[pos]: 750ms
            4. usando for(var pos = 0; pos < str.length; pos++) chr = str.charCodeAt(pos): 50ms

            => re.exec es mucho más rápido que str.replace (obviamente)
            => analizar carácter por carácter con comparaciones str es la misma velocidad que re.exec
            => las comparaciones de números son mucho más rápidas que las comparaciones de un solo carácter
        */
