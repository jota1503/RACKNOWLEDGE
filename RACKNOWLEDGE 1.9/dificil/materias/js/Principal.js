/*
 * TODO:
   * - recuerda la configuración en el hash o en el enlace de oferta
   * - life 1.05 actualmente no funciona
   * - mejor manejo móvil: permite dibujar
   * - saltar a coordinar
   * - hacer capturas de pantalla, tal vez gifs
   * - permitir que las personas carguen patrones
   * - tal vez más de 2 estados (no vida)
   * - solicitudes http a prueba de fallos y análisis de patrones
   * - restaurar la meta vida
   * - error al hacer zoom mientras se carga el patrón
   * - algunos patrones se rompen aleatoriamente (difíciles de reproducir, probablemente relacionados con el cambio de velocidad)
   */
...
(function()
{
    ...
    {
        // IE 8 parece cambiar al modo furioso si el código sólo se carga parcialmente,
         // así que nos despedimos antes
        return;
    }
    ...
    var
        ...
        // funciones que se llaman cuando el patrón deja de ejecutarse
        ...
        // ¿Se ha cargado la lista de patrones?
        /** @type {boolean} */
        patterns_loaded = false,

        /**
         * ruta a la carpeta con todos los patrones
          * @const
          */
        pattern_path = "ejemplos/",
        ...
        // configuraciones de ejemplo que se ejecutan al inicio
         // cargado desde ejemplos/
        /** @type {Array.<string>} */
        ejemplos = (
    ...
    window.onload = function()
    {
        ...
        // Esto se llama cuando se carga un patrón.
         // Tiene que ser llamado al menos una vez antes de que pueda suceder algo.
         // Como siempre cargamos un patrón, no es necesario en este momento.
         //vida.clear_pattern();

         // configuración de producción
         // carga un patrón definido por ?pattern=nombre de archivo (sin extensión)
         // o en su lugar un pequeño patrón aleatorio
        ...
        else if(pattern_parameter_looks_good)
        {
            ...
            {
                // se ha dado un nombre de patrón como parámetro
                 // intenta cargarlo, recurre al patrón aleatorio
        ...
        {
            //La carga de metapíxeles no funciona ahora, mantén esto para más adelante.
            load_random();
        ...
        {
            var random_pattern = ejemplos[Math.random() * ejemplos.length | 0].split(",")[0];
        ...
        function init_ui()
        {
            ...
            drawer.canvas.onmousedown = function(e)
            {
                ...
                {
                    if(drawer.cell_width >= 1) // sólo a niveles de zoom razonables
                    {
            ...
            drawer.canvas.addEventListener("touchstart", function(e)
            {
                ...
                {
                    // simulación del ratón izquierdo
                    var ev = {
                        which: 1,
            ...
            $("randomize_submit").onclick = function()
            {
                ...
                stop(function()
                    ...
                    // Nota: Densidad no exacta porque algunos puntos pueden repetirse
            ...
            if(false)
            {
                ...
                ejemplos.forEach(function(example)
                {
    ...
    function show_overlay(overlay_id)
    {
        ...
        // permitir barras de desplazamiento cuando la superposición es visible
    ...
    function http_get_multiple(urls, ondone, onerror)
    {
        ...
        handlers = urls.map(function(url)
        {
            return http_get(
                ...
                function(result)
                {
                  // una sola solicitud fue exitosa
                    if(error) {
                        return;
                    }
    ...
    /*
     * El evento mousemove que permite moverse.
     */
    ...
    function do_field_draw(e)
    {
        ...
        // no dibujes el mismo píxel dos veces
